...
<div class="container">
	<div class="row">
          	...
          	<div class="alert alert-error">
                <a class="close" data-dismiss="alert" href="#">×</a>Email veya Kullanıcı Adı Daha Önceden Kullanılmış!
            </div>   
...
<div class="container">
	<div class="row">
			<div class="span4 offset4 well" style ="position:relative;right: 0.25in;top:0.50in;height: 3.60in">
