<?php
	include("config.php");
	include("_header.php");
	$gelenid = $_GET['sehirid'];
	mysql_query("SET NAMES UTF8");
	/* üye olan kişilerin firmalarını getirir*/
	$sorgu = "SELECT firmaid, firmaad, yetkilisi, firmalogo FROM  firmauser WHERE ((durum = 1) and (kentad = '$gelenid'));";
	...
	mysql_query("SET NAMES UTF8");
	$result = "SELECT firmaid, firmaad, yetkilisi, firmalogo FROM  firma WHERE ((durum = 1) and (kentad = '$gelenid'));";
