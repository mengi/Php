...
?>
<div class="container"   style ="position:relative;right: 0.25in;top:-0.001in;>
	<div class="row">
          	<div class="alert alert-error">
                <a class="close" data-dismiss="alert" href="#">×</a>Tel, Faks, Gsm-no Geçersizdir (Tel, Faks, Gsm-no Boşluk Bırakmadan Bilgileri Giriniz) !
            </div>   
...
<div class="container">
	<div class="row">
			...
			<form method="POST" action="firmaeklev.php" accept-charset="UTF-8" enctype="multipart/form-data">
