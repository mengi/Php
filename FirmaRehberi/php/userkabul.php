...
<div class="container">
	<div class="row">
          	<div class="alert alert-info">
                <a class="close" data-dismiss="alert" href="#">×</a>Kaydınız Başarılı Bir Şekilde Gerçekleşmiştir.
            </div>   
...
<div class="container">
	<div class="row">
		<div class="span4 offset4 well" style ="position:relative;right: 0.25in;top:0.50in;height: 4.00in">
			...
			<input type="password" id="password" class="span4" name="password" placeholder="Password">
				<input type="password" id="password" class="span4" name="passwordtk" placeholder="Password (Tekrar)">
